...
public class SignUpDto {
    ...
    @NotBlank(message = "You should upload a photo")
    ...
    public SignUpDto(String username, String email, String firstName, String lastName, String password, String telephone, String country, String region, String address, String zip, String photoname, String phototype, String photosize, String photoBase64, double userslongitude, double userslatitude) {
    ...
    public SignUpDto(Long userid, String username, String email, String firstName, String lastName, String password, String telephone, String country, String region, String address, String zip, String photoname, String phototype, String photosize, String photoBase64, double userslongitude, double userslatitude) {
        this.userid = userid;
        this.username = username;
        this.email = email;
        this.firstName = firstName;
